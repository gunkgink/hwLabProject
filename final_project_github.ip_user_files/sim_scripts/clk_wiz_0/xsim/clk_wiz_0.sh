...
#
# Script generated by Vivado on Sun May 11 19:00:44 +0700 2025
...
export RDI_DATADIR="V:/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_0 xil_defaultlib.clk_wiz_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="V:/Vivado/2024.2/data/xsim"
  fi
